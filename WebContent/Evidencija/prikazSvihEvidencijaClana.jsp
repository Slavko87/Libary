...
<title>Prikaz svih evidencija</title>
</head>
<body>
                ...
                <div class="col-lg-5 col-md-7 col-sm-7 mx-auto" >
                   <div class="card rounded-1" >
                        <div class="card-header">
                            <h4 class="mb-0" style="text-align:center;">Prikaz svih evidencija</h4>
                        </div>
                       </div>
                    </div>
            </div>
...
<table class="table table-striped" style="text-align:center; margin-top: 10px; width:1150px;">
							  <thead>
							    <tr>
							      ...
							      <th scope="col">Datum razduzenja</th>
							  ...
							  <%
								 ...
								 ResultSet rs = new EvidencijaIznajmljenihKnjigaDB().dajListuSvihZaduzenjaClana(c.getId());
								 ...
								 while(rs.next())
								 {
									 %>
									  <tr>
									      ...
									      <%
										      if (rs.getTimestamp("datumVracanja") != null)
										      {
										      %>
										      	<td><%=rs.getTimestamp("datumVracanja") %></td>
										      <% 
										      }
										      else
										      {
										      %>
										    	<td><%="Knjiga nije vracena" %></td>
										  	  <%
										      }
